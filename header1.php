...
<div style="width:100%;">
	<div style="float:left;width:50%;align:left;">
		<h1><a class="title" href="/cle/index1.php">Cyber Learning Environment </a></h1><br>
	</div>
	...
	<div id="menu">
		...
		$result2 = mysql_query("SELECT * FROM users WHERE user_name= '$_SESSION[user_name]'");
		$row3 = mysql_fetch_assoc($result2);
		
		if($_SESSION['signed_in'])
		{
			echo '<font size="4" ><b class="wel">Welcome</b></font> <strong><a href="user.php?id=5&name=' . $_SESSION['user_name'] . '" class="nomenu" style="color:white;text-decoration:none;">' .$row3['real_name']. '</strong>.';
		}
		else
		{
		...
		if($_SESSION['signed_in'] == true && $_SESSION['user_level'] == 6 )
		{
			...
			echo ' - <a class="item" href="/cle/user.php?id=0">Profile</a>';
			echo ' - <a class="item" href="/cle/report_user.php">Report User</a>';
			echo ' - <a class="item" href="/cle/mesadm.php">Contact Admin</a>';
			echo ' - <a class="item" href="/cle/signout.php">Sign out</a>';
