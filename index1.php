...
if($_SESSION['signed_in'] == false)
	...
	$_SESSION['user_id']   = NULL;
		...
		<div>
		<br><p>Upload Files:<br><br>
		</div>
		<div style="color:black">
		<menu type="list">
		<ul type="cirlce">
		<li><a href="Upload1.php?id=1"><input type="button" value="Video Lecture"></input></a><br><br>
		<li><a href="Upload1.php?id=2"><input type="button" value="Material" style="width:50%"></input></a><br><br>
		<li><a href="Upload1.php?id=3"><input type="button" value="Assignments"></input></a><br><br>
		</ul>
		</div>		
		</div>
		...
		echo 	'<tr><td>E-mail: <td align="left">'.$_SESSION['user_email'].' <br />
				...
				if($_SESSION['user_level']==6)
					echo '<tr><td>Unique ID: <td align="left">'.$row2['uniq_id'].' <br />';
				else if($_SESSION['user_level']==1)
					echo '<tr><td>Unique ID: <td align="left">4DM1N<br />';
