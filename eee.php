...
{	
	$result1 = mysql_query("Select id,Name,code FROM subjects WHERE Branch ='eee' ");
	...
	{
		echo '<tr><td><a href="eee.php?id='. $data['id'] . '&code='. $data['code'] .'">'. $data['Name'] .'</a>';
	}
		echo '</table></div>';
	...
	else
	{
		...
		<table border="1" style="width:90%;">';
		$code1 = $_GET['code'];
		$name3 = mysql_query("Select * FROM subjects WHERE Branch ='eee' AND code = '$code1' ");
		$data3 = mysql_fetch_assoc($name3);
		echo '<th class="admin" style="color:#F0F0F0;"><a href="eee.php?id=0" style="color:white">'. $data3['Name'] .'</a></th>';
		echo '<tr><td align="middle"><a href="eee.php?id=a&code='. $code1 .'">Video Lectures</a></tr></td>
				<tr><td align="middle"><a href="eee.php?id=b&code='. $code1 .'">Materials</a></tr></td>
				<tr><td align="middle"><a href="eee.php?id=c&code='. $code1 .'">Assignments</a></tr></td>
				 ';
		echo '</table></div>';
	...
	if(htmlspecialchars($_GET["id"]) == 'a')
	{
		...
		<table border="1" style="width:90%;">';
		$code1 = $_GET['code'];
		$name3 = mysql_query("Select Name FROM subjects WHERE Branch ='eee' AND code = '$code1' ");
		$data3 = mysql_fetch_assoc($name3);
		echo '<th class="admin" style="color:#F0F0F0;"><a href="eee.php?id=0" style="color:white">'. $data3['Name'] .'</a></th>';
		echo '<tr><td align="middle"><a href="eee.php?id=a&code='. $code1 .'">Video Lectures</a></tr></td>
				<tr><td align="middle"><a href="eee.php?id=b&code='. $code1 .'">Materials</a></tr></td>
				<tr><td align="middle"><a href="eee.php?id=c&code='. $code1 .'">Assignments</a></tr></td>
				 ';
		echo '</table></div>';
		$result2 = mysql_query("SELECT * FROM vid WHERE branch='eee' AND subj= '$code1' ");
		echo '<div style="float:left;width:15%;color:black;">&nbsp</div>';
		...
		while($data2 = mysql_fetch_assoc($result2))
		{
			...
			echo '<tr align="center"><td><a href =eee.php?id=video&vid='. $data2['v_id']. '&code='. $code1 .'>'. $data2['name'] .'</a></td></tr>';
		}
		echo '</table></div>';
	...
	if(htmlspecialchars($_GET["id"]) == 'video')
	{
		...
		$code1 = $_GET['code'];
		$vidname= $_GET['vid'];
		$name4 = mysql_query("Select video,name FROM vid WHERE Branch ='eee' AND v_id = $vidname ");
	...
	if(htmlspecialchars($_GET["id"]) == 'b')
	{
		...
		echo '<tr><td align="middle"><a href="eee.php?id=a&code='. $code1 .'">Video Lectures</a></tr></td>
				...
				<tr><td align="middle"><a href="eee.php?id=c&code='. $code1 .'">Assignments</a></tr></td>
				 ';
		echo '</table></div>';
		$result2 = mysql_query("SELECT * FROM mat WHERE branch='eee' AND subj= '$code1' ");
		echo '<div style="float:left;width:15%;color:black;">&nbsp</div>';
		echo '<div style="float:left;width:50%;color:black;">';
		echo '<table>';
	...
	if(htmlspecialchars($_GET["id"]) == 'mat')
	{
		...
		$code1 = $_GET['code'];
		$matname= $_GET['mid'];
		$name4 = mysql_query("Select material,name FROM mat WHERE Branch ='eee' AND m_id = $matname ");
		$data4 = mysql_fetch_assoc($name4);
		$name3 = mysql_query("Select Name FROM subjects WHERE Branch ='eee' AND code = '$code1' ");
		$data3 = mysql_fetch_assoc($name3);
		echo '<th class="admin" style="color:#F0F0F0;"><a href="eee.php?id=0" style="color:white">'. $data3['Name'] .'</a></th>';
	...
	if(htmlspecialchars($_GET["id"]) == 'c')
	{
		...
		echo '<tr><td align="middle"><a href="eee.php?id=a&code='. $code1 .'">Video Lectures</a></tr></td>
				...
				<tr><td align="middle"><a href="eee.php?id=c&code='. $code1 .'">Assignments</a></tr></td>
				 ';
		echo '</table></div>';
		$result2 = mysql_query("SELECT * FROM asgn WHERE branch='eee' AND subj= '$code1' ");
		echo '<div style="float:left;width:15%;color:black;">&nbsp</div>';
		echo '<div style="float:left;width:50%;color:black;">';
		echo '<table>';
		...
		while($data2 = mysql_fetch_assoc($result2))
		{
			...
			echo '<tr align="center"><td><a href =eee.php?id=asgn&aid='. $data2['a_id']. '&code='. $code1 .'>'. $data2['name'] .'</a></td></tr>';
		}
		echo '</table></div>';
	...
	if(htmlspecialchars($_GET["id"]) == 'asgn')
	{
		...
		$code1 = $_GET['code'];
		$asgnname= $_GET['aid'];
		$name4 = mysql_query("Select assign,name FROM asgn WHERE Branch ='eee' AND a_id = $asgnname ");
		$data4 = mysql_fetch_assoc($name4);
		$name3 = mysql_query("Select Name FROM subjects WHERE Branch ='eee' AND code = '$code1' ");
		$data3 = mysql_fetch_assoc($name3);
		echo '<th class="admin" style="color:#F0F0F0;"><a href="eee.php?id=0" style="color:white">'. $data3['Name'] .'</a></th>';
