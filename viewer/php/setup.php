			...
			<form class="devaldi" action="setup.php" method="post" onsubmit="return validateConfiguration()">
				...
				<table width="100%" cellspacing="0" cellpadding="0" class="sortable">
						...
						<tr>
							...
							<td>
									<INPUT TYPE=RADIO NAME="SPLITMODE" id="SPLITMODE1" VALUE="0" <?php if($configManager->getConfig('splitmode') == "false" || $configManager->getConfig('splitmode') == "0") { ?>checked="true"<?php } ?> style="vertical-align: middle"> No
									<INPUT TYPE=RADIO NAME="SPLITMODE" id="SPLITMODE2" VALUE="1" <?php if($configManager->getConfig('splitmode') == "true" || $configManager->getConfig('splitmode') == "" || $configManager->getConfig('splitmode') == "1") { ?>checked="true"<?php } ?> style="vertical-align: middle;margin-left:30px;"> Yes<BR>
